...
SOURCES="${HOME}/sources/sprycloud/client"
...
# The version of the sprycloud-client package
NEXTCLOUD_CLIENT_VERSION=2.4.0

# The FULL version of the sprycloud-client package
NEXTCLOUD_CLIENT_FULL_VERSION="${NEXTCLOUD_CLIENT_VERSION}-1.0~@DISTRIBUTION@1"

# The tag of the sprycloud-client package
